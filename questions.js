questions = [
    ...
    },
    {
        ...
        "i18n": {
			...
			"sh": "Socijalističke organizacije su generalno bolje organizovane na decentralizovan način.",
            "es": "Las organizaciones socialistas suelen estar mejor organizadas de manera suelta y descentralizada.",
			"pt": "As organizações socialistas costumam ser mais bem organizadas de maneira livre e descentralizada. "
        },
        "effect": {
            "a": 0,
            "b": 0,
    ...
    },
    {
        ...
        "i18n": {
			...
			"sh": "Sindikati su uglavnom korumpirani od strane vladajuće klase i nisu više održive strukture za socijalističku organizaciju.",
            "es": "El sindicalismo ha sido ampliamente corrompido por la clase dirigente y ya no es una estructura viable para una organización socialista.",
			"pt": "O sindicalismo foi extensivamente corrompido pela classe dominante e não é mais uma estrutura viável para uma organização socialista. "
        },
        "effect": {
            "a": 0,
            "b": 0,
    ...
    //production vs ecology
    {
        ...
        "i18n": {
			...
			"sh": "Klimatske promjene su jedna od glavnih svijetskih prijetnji protiv kojih se svi socijalisti moraju žestoko boriti.",
            "es": "El cambio climático es una gran amenaza mundial que todos los socialistas deben combatir ferozmente.",
    ...
    },
    {
        ...
        "i18n": {
			...
			"sh": "Mjere po kojima se riješavaju ekološka pitanja su neprihvatljive ako rezultuju u značajnom opadu u proizvodnji i kvaliteti života.",
            "es": "Las medidas para abordar las cuestiones ambientales son inaceptables si dan lugar a disminuciones significativas de la producción y la calidad de vida.",
			"pt": "Medidas para resolver questões ambientais são inaceitáveis ​​se levarem a declínios significativos na produção e na qualidade de vida. "
        },
        "effect": {
            "a": 0,
            "b": 0,
    ...
    },
    {
        ...
        "i18n": {
            ...
            "ko": "재생에너지원이 화석 연료를 대체할 수 있으리라 기대하는 것은 어리석은 일이다.",
            "ru": "Глупо ожидать, что возобновляемые источники энергии смогут заменить ископаемые виды топлива.",
            "cn": "指望可再生能源能够取代化石燃料是愚蠢的。",
			"sh": "Budalasto je očekivati da će obnovljivi izvori energije biti sposobni zamjeniti fosilna goriva.",
            "es": "Es una tontería esperar que las fuentes de energía renovable puedan sustituir a los combustibles fósiles.",
			"pt": "É tolice esperar que fontes de energia renováveis ​​possam substituir os combustíveis fósseis. "
        },
        "effect": {
            "a": 0,
            "b": 0,
    ...
    },
    {
        ...
        "i18n": {
			...
			"sh": "Industrijske metode poljoprivrede moraju se abolirati čak i ako to dovede do manje proizvodnje.",
            "es": "Las prácticas agrícolas industrializadas deben ser abolidas incluso si ello conduce a una disminución de la producción.",
			"pt": "As práticas agrícolas industrializadas devem ser abolidas, mesmo que isso leve à diminuição da produção. "
        },
        "effect": {
            "a": 0,
            "b": 0,
    ...
    },
    {
        ...
        "i18n": {
			...
			"sh": "Kao dio postizanja socijalizma, biće bitno uvesti opširnu zaštitu prirodne sredine.",
            "es": "Será importante aplicar amplias protecciones ambientales para lograr el socialismo.",
			"pt": "Extensas proteções ambientais serão importantes para alcançar o socialismo. "
        },
        "effect": {
            "a": 0,
            "b": 0,
    ...
    },
    {
        ...
        "i18n": {
			...
			"sh": "Eksperimentalni ekološki prihvatljivi izvori hrane poput vještački uzgojenog mesa su vrijedni ulaganja.",
            "es": "Merece la pena invertir en fuentes de alimentos experimentales respetuosos con el medio ambiente, como la carne cultivada.",
			"pt": "Vale a pena investir em fontes de alimentos experimentais e ecológicas, como carne feita em laboratórios. "
        },
        "effect": {
            "a": 0,
            "b": 0,
    ...
    },
    {
        ...
        "i18n": {
            ...
            "ko": "자동차 등의 개인용 이동수단은 무료 대중교통수단으로 대체되어야 한다.",
            "ru": "Личные средства транспорта, такие как автомобили, должны быть заменены бесплатным общественным транспортом.",
            "cn": "应该用免费的公共交通工具代替私家车等个人机动车辆。",
			"sh": "Osobna motorna vozila, poput auta, trebaju biti zamijenjena besplatnim javnim prevozom.",
            "es": "Los vehículos de motor personales, como los coches, deben ser sustituidos por el transporte público gratuito.",
    ...
    },
    {
        ...
        "i18n": {
            ...
            "ko": "자연 생태계를 보존하기 위해서라면 인류가 눈에 띄게 고통받는 것도 감수할 수 있다",
            "ru": "Для сохранения природной экосистемы вполне допустимо, чтобы человечество страдало в определенной степени.",
            "cn": "为了保护自然生态系统，人类遭受一定程度的痛苦是可以接受的。",
			"sh": "Prihvatljivo je da čovječanstvo do neke mjeri propati da bi se očuvao prirodni ekosistem.",
            "es": "Es aceptable que la humanidad sufra en cierta medida para preservar el ecosistema natural.",
			"pt": "É aceitável que a humanidade sofra até certo ponto para preservar o ecossistema natural. "
        },
        "effect": {
            "a": 0,
            "b": 0,
    ...
    },
    {
        ...
        "i18n": {
            ...
            "ko": "자연에 대한 착취를 제한하기 위해 음식 소비에 대한 획기적인 변화가 필수적이다.",
            "ru": "Мы должны радикально изменить наше потребление пищи, чтобы ограничить эксплуатацию природы.",
            "cn": "为了限制对自然的开发，我们必须从根本上改变我们的食物消费。",
            "sh": "Moramo radikalno promijeniti naše dijete da bi ograničili iskorištavanje prirode.",
            "es": "Debemos alterar radicalmente nuestro consumo de alimentos para limitar la explotación de la naturaleza.",
			"pt": "Devemos alterar radicalmente nosso consumo de alimentos para limitar a exploração da natureza. "
        },
        "effect": {
            "a": 0,
            "b": 0,
    ...
    },
    {
        ...
        "i18n": {
            ...
            "ko": "생태적 재앙을 피하기 위해선 인구 증가를 억제해야 한다.",
            "ru": "Во избежание экологической катастрофы необходимо ограничить рост численности населения.",
            "cn": "为了防止生态灾难，必须控制人口增长。",
			"sh": "Ljudsko stanovništvo mora se suzbiti kako bi se spriječila ekološka katastrofa.",
            "es": "El crecimiento de la población humana debe ser frenado para prevenir un desastre ecológico.",
			"pt": "O crescimento da população humana deve ser interrompido para evitar um desastre ecológico. "
        },
        "effect": {
            "a": 0,
            "b": 0,
    ...
    },
    {
        ...
        "i18n": {
			...
			"sh": "Uništenje prirode je prihvatljivo dok god donosi značajnu korist čovječanstvu.",
            "es": "Alguna destrucción de la naturaleza en pequeña escala es aceptable si beneficia notablemente a la humanidad.",
			"pt": "Alguma destruição em pequena escala da natureza é aceitável se beneficiar muito a humanidade. "
        },
        "effect": {
            "a": 0,
            "b": 0,
    ...
    },
    {
        ...
        "i18n": {
			...
			"sh": "Čovječanstvo se mora vratiti primitivnim načinima daleke prošlosti da bi prevazišlo dugoročne klimatske probleme.",
            "es": "La humanidad debe volver a las formas primitivas del pasado para superar los problemas climáticos a largo plazo.",
			"pt": "A humanidade deve retornar às formas primitivas do passado para superar os problemas climáticos de longo prazo. "
        },
        "effect": {
            "a": 0,
            "b": 0,
    ...
    },
    {
        ...
        "i18n": {
            ...
            "ko": "우린 20세기의 사회주의 국가들이 환경문제를 심각하게 다루지 않았음을 인정해야만 한다.",
			...
			"sh": "Moramo priznati da socijalističke države XX vijeka nisu ozbiljno riješila ekološka pitanja.",
            "es": "Debemos aceptar que los estados socialistas del siglo XX fracasaron en abordar seriamente las cuestiones ambientales.",
    ...
    //conservative vs progressive
    {
        ...
        "i18n": {
			...
			"sh": "Ugnjetavanje LGBTQ+ osoba je ozbiljan problem koji mora biti riješen.",
            "es": "La opresión hacia las personas LGBTQ+ es un problema importante que debe ser abordado seriamente.",
			"pt": "A opressão em relação às pessoas LGBTQ + é um grande problema que precisa ser tratado com seriedade."
        },
        "effect": {
            "a": 0,
            "b": 0,
    ...
    },
    {
        ...
        "i18n": {
			...
			"sh": "Tradicionalne rodne uloge moraju biti prevaziđene.",
            "es": "Es necesario superar los papeles tradicionales de género, como el que las mujeres sean amas de casa.",
			"pt": "É necessário superar os papéis tradicionais de gênero, como o de mulheres sendo donas de casa. "
        },
        "effect": {
            "a": 0,
            "b": 0,
    ...
    },
    {
        ...
        "i18n": {
			...
			"sh": "Brak je patrijarhalni socijalni konstrukt koji se mora ukinuti.",
            "es": "El matrimonio es una construcción social patriarcal que debe ser eliminada.",
			"pt": "O casamento é uma construção social patriarcal que deve ser removida. "
        },
        "effect": {
            "a": 0,
            "b": 5,
    ...
    },
    {
        ...
        "i18n": {
			...
			"sh": "Abortus je nemoralan čin koji bi se trebao zabraniti ili ozbiljno ograničiti.",
            "es": "El aborto es un acto inmoral que debe ser prohibido o limitado significativamente.",
			"pt": "O aborto é um ato imoral que deve ser proibido ou significativamente limitado. "
        },
        "effect": {
            "a": 0,
            "b": 0,
    ...
    },
    {
        ...
        "i18n": {
			...
			"sh": "Religije su uglavnom imale pozitivan uticaj i trebale bi ostati uticajne u društvu.",
            "es": "Las religiones, en general, tienen un efecto mayormente positivo y deben seguir siendo influyentes en la sociedad.",
			"pt": "As religiões, em geral, têm um efeito amplamente positivo e devem permanecer influentes na sociedade. "
        },
        "effect": {
            "a": 0,
            "b": 0,
    ...
    },
    {
        ...
        "i18n": {
			...
			"sh": "Zatvori su ugnjetavačke i starinske institucije koje moraju biti ukinute.",
            "es": "Las prisiones son instituciones opresivas y anticuadas que deben ser abolidas.",
			"pt": "As prisões são instituições opressivas e ultrapassadas que devem ser abolidas. "
        },
        "effect": {
            "a": 0,
            "b": 0,
    ...
    },
    {
        ...
        "i18n": {
			...
			"sh": "Politika koja omogućuje masovnu stranu imigraciju je naivna i ne bi trebala biti sprovedena.",
            "es": "Las políticas de inmigración masiva extranjera son ingenuas y no deben aplicarse.",
			"pt": "As políticas de imigração em massa estrangeira são ingênuas e não devem ser aplicadas. "
        },
        "effect": {
            "a": 0,
            "b": 0,
    ...
    },
    {
        ...
        "i18n": {
			...
			"sh": "Nemoguće je stvoriti socijalističko društvo bez ostvarivanja značajnog društvenog napretka.",
            "es": "No se puede lograr una sociedad socialista sin hacer también un progreso social significativo.",
